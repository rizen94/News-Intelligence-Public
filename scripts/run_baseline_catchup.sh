...
_export_baseline_env() {
  ...
  export UNIFIED_INTAKE_EXTRACTION_PARALLEL="${BASELINE_CATCHUP_UNIFIED_PARALLEL:-12}"
  export UNIFIED_INTAKE_EXTRACTION_BATCH_SIZE="${BASELINE_CATCHUP_UNIFIED_BATCH_SIZE:-5}"
  export OLLAMA_EXTRACTION_NUM_PREDICT="${BASELINE_CATCHUP_OLLAMA_EXTRACTION_NUM_PREDICT:-4096}"
  export BULK_GPU_PARALLEL="${BASELINE_CATCHUP_GPU_PARALLEL:-10}"
  export BULK_CPU_PARALLEL="${BASELINE_CATCHUP_CPU_PARALLEL:-1}"
  export BULK_DUAL_LANE_CATCHUP="${BASELINE_CATCHUP_DUAL_LANE:-false}"
  ...
  export FAST_NER_ENABLED="${BASELINE_CATCHUP_FAST_NER_ENABLED:-true}"
  export FAST_NER_BACKEND="${BASELINE_CATCHUP_FAST_NER_BACKEND:-spacy}"
  export CONTEXT_CHUNKING_ENABLED="${BASELINE_CATCHUP_CONTEXT_CHUNKING:-false}"
  export ARTICLE_SIGNAL_ENABLED="${BASELINE_CATCHUP_ARTICLE_SIGNAL:-true}"
  export ARTICLE_SIGNAL_FULL_MIN_QUALITY="${BASELINE_CATCHUP_SIGNAL_MIN_QUALITY:-0.50}"
  export UNIFIED_INTAKE_VALUE_PRIORITY_ORDER="${BASELINE_CATCHUP_VALUE_PRIORITY_ORDER:-true}"
  export AUTOMATION_BULK_CATCHUP_PAUSE=1
  export OLLAMA_GPU_CONCURRENCY="${BASELINE_CATCHUP_GPU_PARALLEL:-10}"
