...
fast_startup() {
    ...
    docker-compose -f docker-compose.yml up -d news-system-postgres news-system-redis
    ...
    docker-compose -f docker-compose.yml up -d news-system-app
    ...
    if [ "$1" = "with-monitoring" ]; then
        ...
        docker-compose -f docker-compose.yml up -d news-system-prometheus news-system-grafana
    fi
