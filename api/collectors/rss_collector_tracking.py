"""
RSS Collector with Comprehensive Pipeline Tracking
...
class RSSCollectorTracking:
    """
    RSS collector with comprehensive pipeline tracking and logging
    """
    ...
    def __init__(self, ml_service=None, rag_service=None, pipeline_logger=None):
        ...
        self.multi_perspective_service = MultiPerspectiveStorylineService(ml_service, rag_service)
    ...
    async def _process_article_with_tracking(self, trace_id: str, rss_feed_id: str, 
        ...
        try:
            ...
            if self.multi_perspective_service:
...
# Global instance
_rss_collector_tracking = None

def get_rss_collector_tracking(ml_service=None, rag_service=None, pipeline_logger=None):
    """Get global RSS collector tracking instance"""
    global _rss_collector_tracking
    if _rss_collector_tracking is None:
        _rss_collector_tracking = RSSCollectorTracking(ml_service, rag_service, pipeline_logger)
    return _rss_collector_tracking

# Backward compatibility alias
def get_enhanced_rss_collector(ml_service=None, rag_service=None, pipeline_logger=None):
    """Backward compatibility alias - use get_rss_collector_tracking instead"""
    return get_rss_collector_tracking(ml_service, rag_service, pipeline_logger)
