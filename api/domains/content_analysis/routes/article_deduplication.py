    ...
    try:
        ...
        try:
            ...
            return {
                "success": success,
                "data": {
                    "constraints_added": success,
                    "content_hashes_populated": hash_count
                },
                "message": "Deduplication prevention constraints added" if success else "Failed to add constraints",
                "timestamp": datetime.now().isoformat()
            }
