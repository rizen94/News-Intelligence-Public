    ...
    try:
        ...
        response = {
            ...
            "llm_status": {
                ...
                "last_check": stats['last_llm_check'].isoformat() if stats['last_llm_check'] else None,
...
async def get_domain_llm_activity(
    ...
    try:
        ...
        domain_tasks = [
            task for task in stats['active_tasks']
            if task.get('domain') == domain_schema
        ]
    ...
    try:
                ...
                with conn.cursor() as cur:
                    for schema in ['politics', 'finance', 'science_tech']:
                        try:
                            ...
                            queue_stats[schema] = {"pending": 0, "processing": 0, "completed": 0, "failed": 0}
            finally:
                conn.close()
        ...
        return {
            ...
            "statistics": {
                ...
                "success_rate": round(
                    stats['completed_tasks'] / stats['total_tasks'] 
                    if stats['total_tasks'] > 0 else 0.0, 3
                )
            },
