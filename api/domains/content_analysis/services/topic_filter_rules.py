...
_DATE_TERMS = {
    ...
    "quarter", "q1", "q2", "q3", "q4",
    "am", "pm", "bst", "est", "pst", "cet", "utc", "gmt",
}

# Date/time phrase extensions (slipped through filters: "on friday", "last week", etc.)
_DATE_PHRASES: Set[str] = {
    "on friday", "on monday", "on tuesday", "on wednesday", "on thursday",
    "on saturday", "on sunday",
    "last week", "this week", "next week",
    "last month", "this month", "next month",
    "last year", "this year", "next year",
    "friday morning", "saturday night", "sunday afternoon", "monday evening",
    "yesterday morning", "today afternoon", "tomorrow evening",
    "on the 15th", "on the 16th", "in january", "in february",
}
...
_COUNTRIES: Set[str] = {
    ...
    "denmark", "djibouti", "dominica", "dominican", "ecuador", "egypt",
    "el salvador", "england", "eritrea", "estonia", "ethiopia", "fiji",
    ...
    "rwanda", "saudi", "scotland", "senegal", "serbia", "singapore",
    ...
    "usa", "us", "u.s.", "u.s.a.", "uk", "u.k.", "uae", "ussr",
    "dprk", "prc", "roc",  # North Korea, China, Taiwan
}
...
_NEWS_SOURCES: Set[str] = {
    # Major US
    "breitbart", "cnn", "fox news", "msnbc", "nbc", "abc", "cbs", "npr", "pbs",
    "associated press", "ap news", "reuters", "bloomberg", "axios", "politico",
    "the hill", "huffpost", "huffington post", "usa today", "vox", "vice", "slate",
    "new york times", "washington post", "wall street journal", "los angeles times",
    "daily wire", "newsmax", "oann", "one america news",
    # Major UK & international
    "bbc", "bbc news", "the guardian", "telegraph", "daily mail", "the sun",
    "sky news", "independent", "financial times", "ft", "the times",
    "al jazeera", "rt", "sputnik", "afp", "agence france-presse", "dpa", "ap",
    # Tech & business
    "techcrunch", "the verge", "ars technica", "wired", "engadget", "mashable",
    # Wire services and agencies
    "upi", "dpa", "ap", "reuters", "afp",
}


def should_exclude_from_topic_cloud(text: str, banned_topics: Optional[Set[str]] = None) -> bool:
    """
...
def filter_topic_list(topics: list, name_key: str = "name", banned_topics: Optional[Set[str]] = None) -> list:
    """
...
def filter_word_cloud_entries(entries: list, text_key: str = "text", banned_topics: Optional[Set[str]] = None) -> list:
    """
    ...
    """
    return [e for e in entries if not should_exclude_from_topic_cloud(e.get(text_key, ""), banned_topics=banned_topics)]
