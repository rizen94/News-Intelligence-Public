        ...
        try:
            with conn.cursor() as cur:
                ...
                for row in rows:
                    ...
                    children = [
                        {"id": c[0], "title": c[1], "article_count": c[2]}
        ...
        try:
            with conn.cursor() as cur:
                ...
                if len(rows) != 2:
                    raise HTTPException(
                        status_code=404, 
                        detail="One or both storylines not found"
                    )
        ...
        try:
            with conn.cursor() as cur:
                ...
                if parent_id:
                    ...
                    related["siblings"] = [
                        {"id": r[0], "title": r[1], "article_count": r[2]}
                ...
                if merged_into:
                    ...
                    if m:
                        related["merged_into"] = {
                            "id": m[0], "title": m[1], "article_count": m[2]
                        }
