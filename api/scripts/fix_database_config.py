...
def update_docker_compose():
    ...
    try:
        ...
        if compose_path.exists():
            ...
            content = content.replace('container_name: postgres', 'container_name: news-intelligence-postgres')
            content = content.replace('@postgres:', '@news-intelligence-postgres:')
            
            # Ensure correct password
            content = content.replace('POSTGRES_PASSWORD: Database@NEWSINT2025', 'POSTGRES_PASSWORD: newsapp_password')
...
def main():
    ...
    if config_verified:
        ...
        logger.info("2. Test the database connection: python api/scripts/test_database_connection.py")
        return 0
    else:
