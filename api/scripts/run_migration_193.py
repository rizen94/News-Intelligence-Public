...
def main() -> int:
    ...
    try:
        ...
        path = resolve_migration_sql_file("193_article_topic_clusters_optional_domains.sql")
    ...
    try:
        ...
        with conn.cursor() as cur:
            ...
            cur.execute(sql)
        conn.commit()
        print("✅ 193_article_topic_clusters_optional_domains.sql applied successfully")
        return 0
