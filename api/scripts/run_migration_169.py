...
def main():
    ...
    api_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    path = os.path.join(api_dir, "database", "migrations", "169_storyline_rag_context_by_domain.sql")
    ...
    try:
        ...
        with conn.cursor() as cur:
            cur.execute(sql)
        conn.commit()
        print("✅ 169_storyline_rag_context_by_domain.sql applied successfully")
