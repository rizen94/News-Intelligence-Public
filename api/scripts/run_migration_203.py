...
def main() -> int:
    ...
    try:
        path = resolve_migration_sql_file("203_rss_feeds_deactivate_bad_urls_all_schemas.sql")
    ...
    try:
        ...
        with conn.cursor() as cur:
            ...
            cur.execute(sql)
        conn.commit()
        print("203_rss_feeds_deactivate_bad_urls_all_schemas.sql applied successfully")
        return 0
