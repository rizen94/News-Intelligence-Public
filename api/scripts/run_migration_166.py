...
def main():
    ...
    api_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    path = os.path.join(api_dir, "database", "migrations", "166_article_topic_assignments_context_columns.sql")
    ...
    try:
        ...
        with conn.cursor() as cur:
            ...
            cur.execute(sql)
        conn.commit()
        print("✅ 166_article_topic_assignments_context_columns.sql applied successfully")
