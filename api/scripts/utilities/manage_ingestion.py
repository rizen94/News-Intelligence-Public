...
def run_enhanced_rss_collection() -> bool:
    ...
    try:
        ...
        collect_enhanced_rss()
        logger.info("Enhanced RSS collection completed successfully")
        return True
    except Exception as e:
...
def run_article_pruning() -> bool:
    ...
    try:
        ...
        # Show results
        logger.info(
            f"Pruning analysis completed: {results['total_articles_removed']} articles would be removed"
        )
        ...
        logger.info(
            f"Article pruning completed successfully: {results['total_articles_removed']} articles removed"
        )
        return True
    except Exception as e:
