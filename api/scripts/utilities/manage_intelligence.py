...
def run_intelligence_pipeline(batch_size: int = 100):
    ...
    try:
        ...
        logger.info(f"📊 Results: {results['articles_processed']} articles processed, "
