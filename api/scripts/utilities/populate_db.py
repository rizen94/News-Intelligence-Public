    ...
    try:
        ...
        articles_data = [
            ...
            (
                ...
                "https://example.com/space-tourism",
                "Space News",
                "Science",
                "en",
                0.91,
            ...
            (
                ...
                "https://example.com/cyber-threat",
                "Security Weekly",
                "Technology",
                "en",
                0.88,
        ...
        # Insert articles
        for i, (title, content, url, source, category, language, quality_score) in enumerate(
            articles_data
        ):
