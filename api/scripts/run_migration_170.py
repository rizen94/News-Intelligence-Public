...
def main():
    ...
    api_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    path = os.path.join(api_dir, "database", "migrations", "170_wikipedia_knowledge_and_entity_description.sql")
    ...
    try:
        ...
        with conn.cursor() as cur:
            cur.execute(sql)
        conn.commit()
        print("✅ 170_wikipedia_knowledge_and_entity_description.sql applied successfully")
