-- Migration 290: editorial package decision action for Research modality (v11).
-- Adds research_pass to editorial_package_decisions.action CHECK.
-- Idempotent.
...
ALTER TABLE intelligence.editorial_package_decisions
  ...
  CHECK (
    action IN (
      ...
      'converged', 'reduction_pass', 'narrative_pass', 'research_pass'
    )
  );
