...
from services.log_storage_service import LogEntry, get_log_storage
...
class ErrorHandler:
    ...
    def handle_exception(
        self, exception: Exception, context: dict[str, Any], request: Request | None = None
    ) -> dict[str, Any]:
        """
    ...
    def _check_error_patterns(self, error_type: str, error_context: dict[str, Any]):
        ...
        if self.error_counts[error_type] > threshold:
            self.logger.critical(
                f"Error threshold exceeded for {error_type}: {self.error_counts[error_type]} errors"
            )
    ...
    def _create_error_response(
        self, exception: Exception, error_context: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    def _handle_database_error(
        self, exception: psycopg2.Error, error_context: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    def _handle_sqlalchemy_error(
        self, exception: sqlalchemy.exc.SQLAlchemyError, error_context: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    def _handle_http_error(
        self, exception: HTTPException | StarletteHTTPException, error_context: dict[str, Any]
    ) -> dict[str, Any]:
        """Handle HTTP errors"""
        return {
...
class ErrorRecoveryService:
    ...
    def attempt_recovery(
        self, error_type: str, operation: Callable, *args, max_retries: int = 3, **kwargs
    ) -> Any:
        """
