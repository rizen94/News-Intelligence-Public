"""
Enhanced Storyline Service for News Intelligence System v3.0
...
class EnhancedStorylineService(StorylineService):
    """
    Enhanced storyline service with multi-perspective analysis capabilities
    """
    
    def __init__(self, db_connection=None, ml_service=None, rag_service=None):
        """
        Initialize enhanced storyline service
...
# Global instance
_enhanced_storyline_service = None

def get_enhanced_storyline_service(ml_service=None, rag_service=None) -> EnhancedStorylineService:
    """Get global enhanced storyline service instance"""
    global _enhanced_storyline_service
    if _enhanced_storyline_service is None:
        _enhanced_storyline_service = EnhancedStorylineService(ml_service=ml_service, rag_service=rag_service)
    return _enhanced_storyline_service
