...
class PipelineDeduplicationService:
    ...
    async def run_deduplication_pipeline(self, trace_id: str, feed_id: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                deduplication_results = await self._run_deduplication_analysis(recent_articles, trace_id)
    ...
    async def _get_recent_articles(self, feed_id: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    async def _run_deduplication_analysis(self, articles: List[Dict[str, Any]], trace_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if url_duplicates:
                ...
                logger.info(f"Would merge {merge_results['total_processed']} URL duplicate articles")
    ...
    async def _check_recent_similarities(self, articles: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
