...
class StoryTimelineService:
    ...
    def generate_story_id(self, title: str, content: str = None) -> str:
        ...
        cleaned_text = re.sub(r'\b(the|a|an|and|or|but|in|on|at|to|for|of|with|by)\b', '', text_to_hash.lower())
    ...
    def create_or_update_timeline(self, article_data: Dict[str, Any]) -> Optional[str]:
        ...
        try:
            ...
            existing_query = text("SELECT id, article_count FROM story_timelines WHERE story_id = :story_id")
    ...
    def _calculate_significance_score(self, article_data: Dict[str, Any]) -> float:
        ...
        important_keywords = ['breaking', 'urgent', 'exclusive', 'major', 'significant', 'important']
