...
class SmartCacheService:
    ...
    def __init__(self, db_config: dict[str, str]):
        ...
        self.cache_stats = {"hits": 0, "misses": 0, "evictions": 0, "preloads": 0}
    ...
    async def _store_in_db_cache(
        self, entry: CacheEntry, service: str, query: str, params: dict[str, Any] = None
    ):
    ...
    async def _evict_large_entries(self):
        ...
        try:
            ...
            sorted_entries = sorted(
                self.memory_cache.items(), key=lambda x: x[1].size_bytes, reverse=True
            )
