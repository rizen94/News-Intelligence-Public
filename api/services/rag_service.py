...
class RAGService:
    """RAG service for storyline context enhancement"""
    ...
    async def enhance_storyline_context(self, storyline_id: str, storyline_title: str, 
...
def get_rag_service() -> RAGService:
    ...
    if rag_service is None:
        ...
        rag_service = RAGService(db_config)
    return rag_service
