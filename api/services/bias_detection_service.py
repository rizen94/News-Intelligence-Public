...
class BiasDetectionService:
    def __init__(self, db: Session):
        ...
        self.left_keywords = {
            'progressive': 0.8, 'liberal': 0.9, 'democratic': 0.6, 'socialist': 0.9,
            'equality': 0.7, 'diversity': 0.6, 'inclusion': 0.7, 'climate change': 0.8,
            'environmental': 0.7, 'healthcare': 0.6, 'education': 0.5, 'workers': 0.7,
            'union': 0.8, 'minimum wage': 0.8, 'social justice': 0.9, 'civil rights': 0.8,
            'immigration reform': 0.7, 'gun control': 0.8, 'abortion rights': 0.9,
            'LGBTQ': 0.8, 'feminist': 0.9, 'woke': 0.8, 'systemic racism': 0.9
        }
        
        self.right_keywords = {
            'conservative': 0.8, 'republican': 0.6, 'libertarian': 0.7, 'traditional': 0.6,
            'patriot': 0.7, 'freedom': 0.6, 'liberty': 0.7, 'free market': 0.8,
            'capitalism': 0.8, 'business': 0.5, 'entrepreneur': 0.6, 'tax cuts': 0.8,
            'small government': 0.9, 'states rights': 0.8, 'constitutional': 0.7,
            'law and order': 0.8, 'border security': 0.8, 'immigration control': 0.8,
            'gun rights': 0.8, 'pro-life': 0.9, 'family values': 0.8, 'religious': 0.7,
            'patriotic': 0.7, 'America first': 0.9, 'drain the swamp': 0.8
        }
        
        # Neutral/center indicators
        self.neutral_keywords = {
            'bipartisan': 0.8, 'compromise': 0.7, 'moderate': 0.8, 'centrist': 0.8,
            'balanced': 0.7, 'objective': 0.8, 'factual': 0.9, 'unbiased': 0.9,
            'nonpartisan': 0.8, 'independent': 0.7
        }
        
        # Bias indicators in language
        self.bias_indicators = {
            'emotional_language': ['outrageous', 'shocking', 'devastating', 'incredible', 'amazing'],
    ...
    def _calculate_overall_bias(self, source_bias: Dict[str, Any], content_analysis: Dict[str, float]) -> float:
