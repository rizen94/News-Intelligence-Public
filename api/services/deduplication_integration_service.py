...
class DeduplicationIntegrationService:
    ...
    async def process_new_article(self, article_data: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            await self._log_deduplication_operation(
                ...
                duplicates_found=1
                if (same_source_result and same_source_result.is_duplicate)
                or (cross_source_result and cross_source_result.is_duplicate)
                else 0,
    ...
    async def batch_process_articles(self, article_ids: list[int]) -> dict[str, Any]:
        ...
        try:
            ...
            return {"status": "error", "error": str(e), "articles_processed": len(article_ids)}
    ...
    async def _log_deduplication_operation(
        self,
        operation_type: str,
        article_id: int | None,
