...
from .generation import RAGChunk, RAGGenerationModule, RAGResult
...
class RAGService(BaseRAGService):
    ...
    def analyze_storyline(
        self, domain: str, storyline_id: int, analysis_type: str = "summary"
    ) -> dict[str, Any]:
        """
        ...
        try:
            ...
            return {
                ...
                "domain_entities": [
                    ...
                    for e in (
                        result.domain_context.entities_found
                        if result.domain_context
                        and hasattr(result.domain_context, "entities_found")
                        else []
                    )
                ],
