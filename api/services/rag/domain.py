...
class RAGDomainModule:
        ...
        try:
            ...
            with conn.cursor(cursor_factory=RealDictCursor) as cur:
                ...
                cur.execute("""
                    ...
                    LIMIT %s
                """, (hours, limit * 3))  # Get more for filtering
    ...
    def retrieve_domain_knowledge(
        ...
        domain: str,
        query: str
    ) -> Tuple[List[RAGChunk], Optional[Any]]:
        """
        ...
        # Get domain context
        domain_context = self.knowledge_service.enrich_rag_context(
            domain=domain,
            text=query
        )
    ...
    def get_topic_context(
        ...
        return {
            ...
            "terminology": context.domain_terminology if hasattr(context, 'domain_terminology') else {},
            "historical_context": context.historical_context if hasattr(context, 'historical_context') else '',
            "related_topics": context.related_topics if hasattr(context, 'related_topics') else [],
            "external_sources": context.external_sources if hasattr(context, 'external_sources') else [],
