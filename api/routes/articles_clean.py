...
Clean, consolidated articles management endpoints
"""
...
@router.get("/", response_model=APIResponse, tags=["Articles"])
...
@router.get("/sources", response_model=APIResponse, tags=["Articles"])
...
@router.get("/categories", response_model=APIResponse, tags=["Articles"])
...
@router.get("/{article_id}", response_model=APIResponse, tags=["Articles"])
...
@router.post("/", response_model=APIResponse, tags=["Articles"])
...
@router.put("/{article_id}", response_model=APIResponse, tags=["Articles"])
...
@router.delete("/{article_id}", response_model=APIResponse, tags=["Articles"])
...
@router.post("/search", response_model=APIResponse, tags=["Articles"])
...
@router.post("/{article_id}/analyze", response_model=APIResponse, tags=["Articles"])
...
@router.get("/{article_id}/related", response_model=APIResponse, tags=["Articles"])
...
@router.get("/stats/overview", response_model=APIResponse, tags=["Articles"])
