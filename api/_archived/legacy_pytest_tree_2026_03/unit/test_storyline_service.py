...
class TestStorylineService:
    ...
    @pytest.mark.asyncio
    async def test_evolve_storyline_with_new_content_success(
        self, storyline_service, mock_storyline, mock_articles
    ):
        ...
        with patch.object(storyline_service, "get_db_connection") as mock_db:
            ...
            with patch(
                "domains.storyline_management.services.storyline_service.ContentExtractionService"
            ) as mock_extractor:
                ...
                mock_extractor_instance.extract_article_information = AsyncMock(
                ...
                mock_extractor_instance.identify_new_information = AsyncMock(
                    return_value=mock_new_info
                )
                ...
                result = await storyline_service.evolve_storyline_with_new_content(
                    storyline_id=1, new_article_ids=[3], force_evolution=True
                )
    ...
    async def test_evolve_storyline_not_found(self, storyline_service):
        ...
        with patch.object(storyline_service, "get_db_connection") as mock_db:
            ...
            result = await storyline_service.evolve_storyline_with_new_content(
                storyline_id=999, force_evolution=True
            )
...
class TestContentExtractionService:
    ...
    def extraction_service(self):
        ...
        from domains.storyline_management.services.content_extraction_service import (
    ...
    async def test_extract_article_information_success(self, extraction_service, mock_article):
        ...
        with patch(
            "domains.storyline_management.services.content_extraction_service.llm_service"
        ) as mock_llm:
    ...
    async def test_identify_new_information(self, extraction_service):
        ...
        existing_context = {"key_facts": ["Old fact"], "entities": ["Old Entity"], "dates": []}
