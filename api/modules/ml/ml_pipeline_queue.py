...
from .ml_queue_manager import MLQueueManager, MLTask, TaskPriority, TaskType
...
class MLPipelineQueue:
    ...
    async def process_article_intelligently(
        self, article_id: int, priority: TaskPriority = TaskPriority.NORMAL
    ) -> str:
        ...
        try:
            ...
            content_analysis_task = MLTask(
                ...
                payload={"article_data": article, "analysis_type": "comprehensive"},
            ...
            sentiment_task = MLTask(
                ...
                priority=priority,
                article_id=article_id,
                payload={"article_data": article, "analysis_depth": "comprehensive"},
    ...
    async def generate_timeline_intelligently(
        self, storyline_id: str, priority: TaskPriority = TaskPriority.NORMAL
    ) -> str:
        """
    ...
    async def process_storyline_intelligently(
        self, storyline_id: str, priority: TaskPriority = TaskPriority.HIGH
    ) -> str:
        ...
        try:
            ...
            # Submit task
            self.queue_manager.submit_task(analysis_task)
    ...
    async def batch_process_articles(
        self, article_ids: list[int], priority: TaskPriority = TaskPriority.NORMAL
    ) -> str:
        ...
        try:
            ...
            for keyword in keywords:
                keyword_conditions.append(
                    "(title ILIKE %s OR content ILIKE %s OR summary ILIKE %s)"
                )
    ...
    def _get_processing_statistics(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {"task_statistics": task_stats, "article_statistics": article_stats}
