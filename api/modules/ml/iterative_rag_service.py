...
class IterativeRAGService:
    ...
    async def enhance_article_with_context(
        self, article_id: str, max_iterations: int = 3
    ) -> dict[str, Any]:
        ...
        try:
            ...
            return {"article_id": article_id, "error": str(e), "status": "failed"}

    async def build_context_iteratively(
