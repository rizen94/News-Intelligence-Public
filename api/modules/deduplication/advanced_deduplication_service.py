...
class ClusterResult:
    ...
    storyline_suggestion: Optional[str] = None
...
class AdvancedDeduplicationService:
    ...
    def _calculate_cluster_centroid(self, articles: List[ArticleMetadata], 
                                  tfidf_matrix, cluster_id: int, 
                                  cluster_labels) -> Tuple[str, str]:
        """Calculate cluster centroid"""
        try:
    ...
    def _generate_storyline_suggestion(self, articles: List[ArticleMetadata], 
                                     centroid_title: str) -> str:
