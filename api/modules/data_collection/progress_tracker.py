...
class ProgressTracker:
    ...
    def update_feed_progress(self, collection_id: str, feed_name: str, 
                           feed_progress: int, feed_total: int):
        """
        ...
        with self._lock:
            if collection_id in self._progress:
                ...
                logger.debug(f"Collection {collection_id}: {feed_name} - {feed_progress}/{feed_total} articles")
    
    def complete_feed(self, collection_id: str, feed_name: str, 
                     articles_collected: int, new_articles: int, 
                     duplicate_articles: int, success: bool = True):
        """
        ...
        with self._lock:
            if collection_id in self._progress:
                ...
                logger.info(f"Collection {collection_id}: Completed {feed_name} - "
    ...
    def complete_collection(self, collection_id: str, success: bool = True):
        ...
        with self._lock:
            if collection_id in self._progress:
                ...
                logger.info(f"Collection {collection_id} completed: "
    ...
    def get_progress(self, collection_id: str) -> Optional[CollectionProgress]:
        """
