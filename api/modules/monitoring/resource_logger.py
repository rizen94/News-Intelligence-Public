...
class ResourceLogger:
    ...
    def _init_database(self):
        ...
        try:
            ...
            cursor.execute(
                "CREATE INDEX IF NOT EXISTS idx_perf_events_timestamp ON performance_events(timestamp)"
            )
    ...
    def log_performance_event(
        self, event_type: str, description: str, severity: str = "info", metadata: dict = None
    ):
    ...
    def cleanup_old_metrics(self, days_to_keep: int = 30):
        ...
        try:
            ...
            self.logger.info(
                f"Cleaned up old metrics: {system_deleted} system, {app_deleted} app, {events_deleted} events"
            )
