...
class RAGSystemTester:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if found_model:
                    ...
                    test_model = found_model if '8b' in found_model.lower() else model_names[0] if model_names else found_model
                    ...
                    if test_result:
                        ...
                        print(f"⚠ Model generation test skipped (may be slow with large models)")
                else:
                    print(f"⚠ Llama model not found")
    ...
    def test_ollama_generation(self, model_name: str = None) -> bool:
        ...
        try:
            ...
            print(f"  Generation timeout (model may be too large, this is OK)")
    ...
    def test_sentence_transformers(self):
        ...
        try:
            ...
            print(f"  Model is cached and will persist")
    ...
    def test_enhanced_rag_retrieval(self):
        ...
        try:
            ...
            print(f"✓ Enhanced RAG Retrieval initialized")
            ...
            if retrieval.embedding_model:
                ...
                print(f"⚠ Embedding model not loaded (sentence-transformers not available)")
            ...
            try:
                ...
                if results:
                    ...
                    print(f"⚠ No articles found (database may be empty)")
