...
[![Version](https://img.shields.io/badge/version-3.1.0-blue.svg)](https://github.com/your-repo/news-intelligence)
...
- **[Project Status](PROJECT_STATUS_v3.1.0.md)**: Current project state
- **[API Reference](API_REFERENCE_v3.1.0.md)**: Complete API documentation
- **[Deployment Guide](DEPLOYMENT_GUIDE_v3.1.0.md)**: Deployment instructions
- **[Changelog](CHANGELOG_v3.1.0.md)**: Detailed change history
...
### Resources
- **API Docs**: http://localhost:8000/docs
- **Project Status**: [PROJECT_STATUS_v3.1.0.md](PROJECT_STATUS_v3.1.0.md)
- **Deployment Guide**: [DEPLOYMENT_GUIDE_v3.1.0.md](DEPLOYMENT_GUIDE_v3.1.0.md)
