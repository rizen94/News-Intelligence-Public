...
from collectors.rss_collector import collect_rss_feeds, collect_rss_feed
import requests
...
class AutomatedCollection:
    ...
    def trigger_ml_processing(self):
        ...
        try:
            ...
            response = requests.post(f"{self.api_base_url}/api/ml-management/process", 
            ...
            if response.status_code == 200:
                ...
                logger.error(f"Failed to trigger ML processing: {response.status_code} - {response.text}")
                return 0
