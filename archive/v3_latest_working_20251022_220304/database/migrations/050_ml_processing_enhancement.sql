-- ============================================================================
-- ML PROCESSING ENHANCEMENT MIGRATION
-- ============================================================================
-- Adds enhanced ML processing tracking with queue position and timing
-- Migration: 050_ml_processing_enhancement.sql
-- Date: $(date)
-- ============================================================================
...
GRANT EXECUTE ON FUNCTION get_ml_processing_queue() TO news_intelligence_user;
GRANT EXECUTE ON FUNCTION update_ml_queue_positions() TO news_intelligence_user;
GRANT EXECUTE ON FUNCTION estimate_next_ml_processing() TO news_intelligence_user;
