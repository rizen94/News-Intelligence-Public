...
class NLPClassifierService:
    ...
    def __init__(self):
        ...
        self.model = None
        self.categories = [
            "politics", "economy", "technology", "climate", "world", "business",
            "entertainment", "sports", "lifestyle", "gossip"
        ]
        ...
        if TRANSFORMERS_AVAILABLE:
            ...
            self.logger.warning("Using basic text analysis - install transformers for better classification")
    ...
    async def _classify_with_transformers(self, text: str) -> ClassificationResult:
        ...
        try:
            ...
            is_relevant = best_label in self.relevant_categories and best_confidence >= self.threshold
            ...
            if not is_relevant:
                if best_label not in self.relevant_categories:
                    ...
                    reasoning += f" (confidence {best_confidence:.2f} below threshold {self.threshold})"
    ...
    async def _classify_with_basic_analysis(self, text: str) -> ClassificationResult:
        ...
        try:
            ...
            category_keywords = {
                ...
                "entertainment": [
                    "celebrity", "movie", "film", "actor", "actress", "singer", "musician",
                    "hollywood", "oscar", "grammy", "emmy", "entertainment", "show",
                    "television", "tv", "series", "drama", "comedy"
                ],
                "sports": [
                    "sports", "football", "basketball", "baseball", "soccer", "hockey",
                    "nfl", "nba", "mlb", "nhl", "olympics", "world cup", "championship",
                    "game", "match", "player", "team", "coach"
                ],
                "lifestyle": [
                    "fashion", "beauty", "makeup", "lifestyle", "trending", "viral",
                    "social media", "instagram", "tiktok", "influencer", "style",
                    "design", "art", "culture", "food", "travel"
                ],
                "gossip": [
                    "gossip", "rumor", "scandal", "divorce", "marriage", "dating",
                    "relationship", "breakup", "cheating", "affair", "drama"
                ]
            }
    ...
    async def batch_classify_articles(self, articles: List[Dict[str, Any]]) -> List[ClassificationResult]:
    ...
    async def get_classification_stats(self) -> Dict[str, Any]:
        ...
        try:
            return {
                ...
                "model_name": "facebook/bart-large-mnli" if self.classifier else "basic_text_analysis"
            }
        except Exception as e:
