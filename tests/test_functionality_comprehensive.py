    ...
    def test_article_creation_and_retrieval(self):
        ...
        if response.status_code == 200:
            ...
            if get_response.status_code == 200:
                ...
                assert retrieved_article["source_domain"] == self.test_data["test_article"]["source_domain"]
                ...
                if articles:
                    ...
                    if add_response.status_code == 200:
                        ...
                        if storyline_response.status_code == 200:
                            ...
                            print(f"❌ Failed to retrieve storyline: {storyline_response.status_code}")
                            return False
                    else:
            ...
            if monitoring_data.get("success"):
                ...
                if articles_response.status_code == 200 and storylines_response.status_code == 200:
                    ...
                    if total_articles == articles_count and total_storylines == storylines_count:
                        ...
                        print(f"❌ Data inconsistency: monitoring({total_articles}, {total_storylines}) vs endpoints({articles_count}, {storylines_count})")
                        return False
                else:
