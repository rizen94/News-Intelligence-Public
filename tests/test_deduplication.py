...
from modules.deduplication import DeduplicationManager, ContentNormalizer
...
def test_content_normalizer():
    ...
    print(f"   ✓ Content metrics: {metrics['word_count']} words, {metrics['sentence_count']} sentences")
...
def test_deduplication_engine():
    ...
    try:
        ...
        print(f"   ✓ Configuration loaded: semantic_threshold={engine.config['semantic_threshold']}")
...
def test_duplicate_detection():
    ...
    try:
        ...
        print(f"   ✓ Article 1 processed: {'Duplicate' if result1['duplicate_status']['is_duplicate'] else 'Unique'}")
        ...
        print(f"   ✓ Article 2 processed: {'Duplicate' if result2['duplicate_status']['is_duplicate'] else 'Unique'}")
