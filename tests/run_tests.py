...
class TestRunner:
    ...
    def __init__(self):
        ...
        self.results = {"start_time": datetime.now().isoformat(), "test_suites": {}, "summary": {}}
    ...
    def run_test_suite(self, suite_name, test_path, description):
        ...
        result = pytest.main(
            [
                ...
                "--junitxml",
                str(self.test_dir / f"results_{suite_name.lower()}.xml"),
            ]
        )
    ...
    def print_final_summary(self):
        ...
        print(
            f"🎯 Overall Result: {summary['passed_suites']}/{summary['total_suites']} test suites passed"
        )
        ...
        for suite_name, suite_data in self.results["test_suites"].items():
            ...
            print(
                f"  {status_emoji} {suite_name}: {suite_data['status']} ({suite_data['duration']:.2f}s)"
            )
