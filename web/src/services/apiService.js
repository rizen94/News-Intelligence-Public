...
export const apiService = {
  ...
  getMultiPerspectiveAnalysis: async (storylineId) => {
    try {
  ...
  getImpactAssessment: async (storylineId) => {
    try {
  ...
  getHistoricalContext: async (storylineId) => {
    try {
  ...
  getPredictiveAnalysis: async (storylineId) => {
    try {
  ...
  getExpertAnalysis: async (storylineId) => {
    try {
      ...
      return {
        ...
        rssStats: {
          ...
          data: {
            ...
            active_feeds: rssFeeds.data?.feeds?.filter(feed => feed.is_active !== false).length || 0,
