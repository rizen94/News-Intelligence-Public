...
function App() {
  ...
  const loadSystemData = async () => {
    try {
      ...
      // Load system health, article stats, and RSS stats in parallel
      const [healthResponse, articleStatsResponse, rssStatsResponse] = await Promise.all([
        apiService.getSystemHealth(),
        apiService.getArticleStats(),
        apiService.getRSSStats()
      ]);
      ...
      setAppState({
        ...
        articleStats: articleStatsResponse.data,
        rssStats: rssStatsResponse.data
      });
    } catch (error) {
