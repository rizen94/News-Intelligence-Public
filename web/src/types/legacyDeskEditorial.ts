/**
 * Legacy desk / storyline editorial types (5W1H editorial_document, report payload).
 * Not the v11 Editorial Package client — that lives in `services/api/editorial.ts`.
 */
