  ...
  const content = (
    ...
    >
      <Chip
        ...
        sx={{
          cursor:
            profileId != null || entity.has_dossier ? 'pointer' : 'default',
          '&:hover':
            profileId != null || entity.has_dossier
        ...
        <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
          ...
          {entity.has_dossier && (
            <Link
              ...
              onClick={() =>
                navigate(
                  `/${domain}/investigate/entities/${canonicalId}/dossier`
                )
              }
              sx={{ cursor: 'pointer' }}
            >
  ...
  if (mode === 'popover') {
    ...
    return (
      <>
        ...
        >
          <Box sx={{ p: 1.5 }}>{expandedContent}</Box>
        </Popover>
      </>
    );
  }
