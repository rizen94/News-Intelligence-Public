import { Delete, Add, Edit, Warning as WarningIcon } from '@mui/icons-material';
import {
  Dialog,
  DialogTitle,
  DialogContent,
    ...
    >
      <DialogTitle>
        <Box display='flex' alignItems='center' gap={2}>
          {actionDetails.icon}
          <Typography variant='h6'>{actionDetails.title}</Typography>
        </Box>
      </DialogTitle>
          ...
          {storyline && action === 'delete' && (
            <Alert severity='warning' sx={{ mt: 2 }}>
              <Typography variant='body2'>
                ...
                storyline and all associated data.
              </Typography>
            </Alert>
          )}
      ...
      <DialogActions sx={{ p: 2 }}>
        ...
        <Button
          ...
          disabled={loading}
          startIcon={
            loading ? <CircularProgress size={20} /> : actionDetails.icon
          }
        >
