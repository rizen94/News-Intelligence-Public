          ...
          >
            <Box>
              ...
              <Typography variant='body2' sx={{ opacity: 0.9 }}>
                Ask questions about gold, commodities, or market data. Get cited
                ...
                {goldData?.observations?.length > 0 ? (
                  <Box>
                    <Typography variant='subtitle2'>
                      {goldData.observations.length} observations (prefer{' '}
                      {goldData.prefer_unit || 'USD/oz'})
                    </Typography>
                      ...
                      {goldData.observations
                        ...
                        .map((o: any, i: number) => (
                          <Typography key={i} variant='body2' component='div'>
                            {o.date}:{' '}
                            {o.value != null
                              ? Number(o.value).toLocaleString(undefined, {
                        ...
                        >
                          {(src.symbols || []).map((sym: string) => (
                            <Chip
                              ...
                              size='small'
                              variant={
                                selectedSymbol === sym ? 'filled' : 'outlined'
                              }
                ...
                <CardContent>
                  ...
                  {marketData?.symbol === selectedSymbol ? (
                    marketData.observations?.length > 0 ? (
                      <Box sx={{ mt: 2 }}>
                        <Typography variant='subtitle2'>
                          Stored observations: {marketData.observations.length}
                        </Typography>
                      ...
                      <Typography
                        ...
                        sx={{ mt: 1 }}
                      >
                        No observations in store. Click Fetch from FRED to load
            ...
            <Card>
              <CardContent>
                ...
                {marketTrends ? (
                  <Box>
                    <Typography variant='body2' color='text.secondary'>
                      Market trends and analytics will be displayed here once
                      the backend API is implemented.
                    </Typography>
                    <Box sx={{ mt: 2 }}>
                      <Chip
                        label='API Endpoint: /api/finance/finance/market-trends'
                        color='info'
                        size='small'
                      />
                    </Box>
                  ...
                  <Typography variant='body2' color='text.secondary'>
                    No market data available. The backend API endpoint needs to
                    be implemented.
                  </Typography>
                )}
              </CardContent>
