...
const IntelligenceDashboard = () => {
  ...
  const getTrendIcon = direction => {
    ...
    default:
      return <TrendingFlatIcon color='default' />;
    }
  };
  ...
  const getAlertSeverity = severity => {
    ...
    case 'medium':
      return { color: 'info', icon: <NotificationsIcon /> };
    case 'low':
      return { color: 'success', icon: <CheckCircleIcon /> };
    default:
      return { color: 'default', icon: <NotificationsIcon /> };
    }
  };
              ...
              >
                <Box>
                  ...
                  <Typography color='textSecondary' variant='body2'>
                    {insights.filter(i => i.confidence >= 0.8).length} high
                    confidence
                  </Typography>
                </Box>
            ...
            <CardContent>
              ...
              >
                <Box>
                  ...
                  <Typography color='textSecondary' variant='body2'>
                    {trends.filter(t => t.direction === 'up').length} trending
                    up
                  </Typography>
                </Box>
                  ...
                  <CardHeader
                    avatar={
                      <Avatar
                        sx={{
                          bgcolor:
                            getInsightColor(insight.confidence) + '.main',
                        }}
                      >
                  ...
                  <List>
                    {Object.entries(categoryStats).map(([category, count]) => (
                      <ListItem key={category}>
                        <ListItemIcon>{getInsightIcon(category)}</ListItemIcon>
                        <ListItemText
                          primary={category}
                    ...
                    <Box>
                      <Box display='flex' justifyContent='space-between' mb={1}>
                        ...
                        <Typography variant='body2'>
                          {
                            insights.filter(
                              i => i.confidence >= 0.6 && i.confidence < 0.8,
                            ).length
                          }
                        </Typography>
                      </Box>
