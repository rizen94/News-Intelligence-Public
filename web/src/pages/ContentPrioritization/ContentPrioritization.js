  ...
  const loadData = async() => {
    ...
    try {
      ...
      if (!prioritiesResponse.success) {
        ...
        console.error(
          'Failed to load content priorities:',
                  ...
                  <ListItemText
                    ...
                    secondary={
                      <Box>
                        ...
                        <Typography variant='body2' color='text.secondary'>
                          Assigned by: {priority.assigned_by} •{' '}
                          {new Date(priority.assigned_at).toLocaleString()}
                        </Typography>
                      </Box>
                    }
                  />
                ...
                <ListItem key={thread.id} divider>
                  <ListItemText
                    ...
                    secondary={
                      <Box>
                        <Typography variant='body2' color='text.secondary'>
                          Articles: {thread.article_count} • Last updated:{' '}
                ...
                {priorityStats && (
                  <Box>
                    ...
                    >
                      ...
                      <Typography variant='subtitle2'>
                        {priorityStats.avg_priority_score}
                      </Typography>
                    </Box>
                  </Box>
                )}
