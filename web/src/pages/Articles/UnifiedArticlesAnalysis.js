...
const UnifiedArticlesAnalysis = () => {
  ...
  const renderDailyDigestTab = () => {
    ...
    const processedToday = todayArticles.filter(
      article =>
        article.processingStatus === 'completed' ||
        article.processingStatus === 'processed',
    );
    const pendingToday = todayArticles.filter(
      article => article.processingStatus === 'pending',
    );
          ...
          <div className='unified-content-card unified-fade-in'>
            ...
            <div className='unified-content-body'>
              <div className='unified-content-text'>
                ...
                <strong>
                  {Math.round(
                    (processedToday.length / todayArticles.length) * 100,
                  ) || 0}
                  %
                </strong>{' '}
                processing rate
              ...
              {processedToday.length > 0 ? (
                <List>
                  {processedToday.slice(0, 5).map(article => (
                    ...
                    >
                      <ListItemText
                        ...
                        secondary={`${article.source} • ${new Date(
                          article.publishedDate,
                        ).toLocaleTimeString()}`}
                      />
                    </ListItem>
                  ...
                  {processedToday.length > 5 && (
                    <ListItem>
                      <ListItemText
                        primary={`... and ${processedToday.length - 5} more`}
                      />
                    </ListItem>
                  )}
                </List>
                ...
                <div className='unified-content-text'>
                  No articles processed today yet.
                </div>
              )}
            </div>
          </div>
              ...
              {pendingToday.length > 0 ? (
                <List>
                  ...
                  {pendingToday.length > 5 && (
                    <ListItem>
                      <ListItemText
                        primary={`... and ${pendingToday.length - 5} more`}
                      />
                    </ListItem>
                  )}
                </List>
        ...
        <div className='unified-content-card unified-fade-in'>
          ...
          <div className='unified-content-body'>
            {clusters.length > 0 ? (
              <div className='unified-grid unified-grid-2'>
                {clusters.map((cluster, index) => (
                  <div
                    ...
                    className='unified-content-card unified-scale-in'
                  >
                    <div className='unified-content-header'>
                      <div className='unified-content-title'>
                        {cluster.topic || 'Untitled Cluster'}
                      </div>
                    </div>
                    <div className='unified-content-body'>
                      <div className='unified-content-text'>
              ...
              <div className='unified-content-text'>
                No clusters available. Run clustering analysis to group related
                articles.
              </div>
            )}
          </div>
        ...
        <div className='unified-content-card unified-fade-in'>
          ...
          <div className='unified-content-body'>
            {entities.length > 0 ? (
              ...
              <div className='unified-content-text'>
                No entities extracted yet. Run entity extraction to identify
