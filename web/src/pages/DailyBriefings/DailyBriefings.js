...
const DailyBriefings = () => {
  ...
  const loadData = async() => {
    ...
    try {
      ...
      const [templatesResponse, briefingsResponse, statsResponse] =
        await Promise.all([
      ...
      if (!templatesResponse.success) {
        ...
        console.error(
          'Failed to load briefing templates:',
      ...
      if (!briefingsResponse.success) {
        ...
        console.error(
          'Failed to load generated briefings:',
          briefingsResponse.error,
        );
      } else {
      ...
      if (failures.length > 0) {
        const errorMessage = `Failed to load: ${failures.join(
          ', ',
                    ...
                    <ListItem key={template.id} divider>
                      ...
                      <ListItemSecondaryAction>
                        <Tooltip title='Generate Briefing'>
                          <IconButton
                            onClick={() => handleGenerateBriefing(template.id)}
                          >
                            <AutoAwesome />
                          </IconButton>
                        </Tooltip>
      ...
      <TabPanel value={activeTab} index={1}>
        <Card>
          <CardContent>
            ...
            >
              <Typography variant='h6'>Generated Briefings</Typography>
              <Button
                variant='outlined'
                startIcon={<Refresh />}
                onClick={loadData}
                ...
                <ListItem key={briefing.id} divider>
                  <ListItemText
                    ...
                    secondary={
                      <Box>
                        <Typography variant='body2' color='text.secondary'>
                          Articles: {briefing.article_count} • Words:{' '}
                          {briefing.word_count}
                        </Typography>
                        <Typography variant='body2' color='text.secondary'>
                          Generated:{' '}
                ...
                {briefingStats && (
                  <Box>
                    ...
                    >
                      ...
                      <Typography>
                        {briefingStats.briefings_this_week}
                      </Typography>
                    </Box>
                    <Box
                      sx={{
                    ...
                    >
                      ...
                      <Typography>
                        {briefingStats.avg_articles_per_briefing}
                      </Typography>
                    </Box>
                    <Box
                      sx={{
                    ...
                    >
                      ...
                      <Typography variant='subtitle2'>
                        {briefingStats.most_popular_template}
                      </Typography>
                    </Box>
                  </Box>
                )}
            ...
            <Box>
              ...
              <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
                ...
                <Chip
                  ...
                  color={getStatusColor(selectedBriefing.status)}
                />
              </Box>
            </Box>
          )}
