...
export default function Clusters() {
  ...
  const filteredClusters = clusters.list.filter(cluster => {
    if (
      searchQuery &&
      !cluster.topic.toLowerCase().includes(searchQuery.toLowerCase()) &&
      ...
      <DialogContent>
        {selectedCluster && (
          <Box>
            ...
            <Grid container spacing={2} sx={{ mb: 3 }}>
              ...
              <Grid item xs={12} md={6}>
                ...
                <Typography variant='body1'>
                  {selectedCluster.articleCount} articles
                </Typography>
              </Grid>
              <Grid item xs={12} md={6}>
                <Typography
              ...
              <Grid item xs={12} md={6}>
                ...
                <Chip
                  ...
                  color={
                    selectedCluster.trendScore > 50 ? 'success' : 'default'
                  }
                />
              </Grid>
              <Grid item xs={12} md={6}>
            ...
            {selectedCluster.keyEntities &&
              selectedCluster.keyEntities.length > 0 && (
              <Box sx={{ mb: 3 }}>
