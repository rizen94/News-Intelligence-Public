    ...
    return (
      <Box sx={{ p: 2 }}>
        <Typography color='text.secondary'>
          Gold commodity view is available only in the Finance domain.
        </Typography>
      </Box>
    );
  }
    ...
    <Box>
      ...
      <Card variant='outlined' sx={{ mb: 3 }}>
        <CardHeader
          ...
          subheader='Tracked events (gold / finance)'
        />
        <CardContent>
          {loading ? (
        ...
        <Grid item xs={12} md={4}>
          <Card variant='outlined'>
            <CardHeader
              ...
              subheader='Country-level events'
            />
            <CardContent>
              <Typography variant='body2' color='text.secondary'>
                Events with geographic scope appear in the map and timeline.
                Select a country on the map to filter.
              </Typography>
            </CardContent>
          </Card>
        </Grid>
          ...
          <Card variant='outlined'>
            ...
            <CardContent>
              <Typography variant='body2' color='text.secondary'>
                ...
                here as the pipeline ingests EDGAR and gold-related articles.
              </Typography>
            </CardContent>
          </Card>
        </Grid>
