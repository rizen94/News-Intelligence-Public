...
- Files matching these patterns are excluded: **/__pycache__/**, **/.venv/**, **/venv/**, news-intelligence-kit/**, .cursor/**, repomix-nri-output.*
...
NRI (Investigation) — Repomix bundle from api/nri_core/ after monorepo unification and import normalization (unification/big-bang, 2026-06-24).
...
## File: api/nri_core/evidence/bridge_qa.py
````python
...
## File: api/nri_core/vault/reader/__init__.py
````python

````

## File: api/nri_core/vault/reader/hypothesis_reader.py
````python
...
## File: api/nri_core/vault/validator/__init__.py
````python
"""Vault validation helpers."""
````

## File: api/nri_core/vault/validator/firewall.py
````python
...
## File: api/nri_core/vault/__init__.py
````python
