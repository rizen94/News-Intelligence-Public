...
**Retired:** The old flat `/api/...` router was removed from `main.py`; an archived copy for reference lives at `api/archive/legacy_api/legacy_global_api.py` (see `api/archive/legacy_api/README.md`).
...
| `topics.ts` | `/api/{domain}/content_analysis/topics`, `/api/{domain}/topics/*`, `/api/topics/categories/stats` |
